...
Vue.component('images-pending', {
    ...
    methods: {
        ...
        getImages: function(offset = this.offset, cat_id = this.cat_id,  count = this.perPage) {
            this.showLoader();
            this.$http.get('/dashboard/images/get/pending/' + cat_id + '/' + count + '/' + offset).then(response => {
        ...
        getCountOfImages: function(cat_id = this.cat_id) {
            ...
            this.$http.get('/dashboard/images/get/count/' + cat_id).then(response => {
        ...
        approveImage: function(imageId) {
            this.$http.get('/dashboard/images/approve/' + imageId).then(response => {
                this.getImages();
            }, response => {
                console.log('Some error with images api!');
            });
